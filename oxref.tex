...
\@ifpackageloaded{fontspec}{%
  ...
  \newcommand{\booksym}[1]{\makebox[1em][c]{\faicon{book}}}
  \newcommand{\cogsym}[1]{\makebox[1em][c]{\faicon{cog}}}
}{%
  \usepackage[utf8]{inputenc}
  \usepackage[varl]{zi4}
  \usepackage{dictsym}
  \newcommand{\booksym}[1]{\makebox[1em][c]{\dsliterary}}
  \newcommand{\cogsym}[1]{\makebox[1em][c]{\dstechnical}}
}
\makeatother
...
\tcbuselibrary{listingsutf8,breakable,xparse}
...
\addtostream{src}{\string\ProvidesFile{oxnotes.bbx}}
...
\addtostream{src}{\string\ProvidesFile{oxyear.bbx}}
...
\newcommand{\docbibexample}[4]{%
  ...
  \addtostream{#1}{\space\space\string\booksym{} #2}
  \addtostream{#1}{\space\space\string\par\string\cogsym{} \string\fullcite{#3}.}
...
\bibexample
|Edmond Vander Straeten, \emph{La Musique aux Pays-Bas avant le XIX\textsuperscript{e} siècle}, ii (Brussels, 1867--88), 367--8.|%[367--368]
||%
...
\commondoc|
\aside{In the \emph{Oxford Style Manual}, the translator is in parentheses in the following reference, but as this pattern does not occur in any other it may be an error or stylistic variation. The following effect was achieved with \code{volume = \{1--iii\}}, \code{pages = \{iv\}}, and \code{pubstate = \{London: Bohn, 1846\}}.}
|
...
\commondoc|
\section*{15.19.2} % Author–date system: Reference section
|
