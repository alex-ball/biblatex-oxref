...
% can still override them.
%
\ExecuteBibliographyOptions{uniquename=init,giveninits,labeldate,sorting=nyt,pagetracker}
%
% == Date merging option ==
%
...
%
% We declare a variant of the `family-given' name format that uses the
...
% version.
%
\DeclareNameFormat{oxyear-family-given}{%
  \nameparts{#1}%
  \ifthenelse{
...
\DeclareNameAlias{author}{oxyear-family-given}
\DeclareNameAlias{editor}{oxyear-family-given}
