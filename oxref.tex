...
% `\printdate'.
%
\DeclareRobustCommand*{\mkbibrangefull}[2]{%
  \iffieldundef{#2year}{%
    \iffieldundef{#2month}{}{%
      \printtext[#2date]{%
...
\DeclareRobustCommand*{\mkbibrangetrunc}[2]{%
  \iffieldundef{#2year}{%
    \iffieldundef{#2month}{}{%
      \printtext[#2date]{%
...
\DeclareRobustCommand*{\mkbibrangefullextra}[2]{%
  \iffieldundef{#2year}{%
    \iffieldundef{#2month}{}{%
      \printtext[#2date]{%
        \csuse{mkbibdate#1}{}{#2month}{#2day}%
...
\DeclareRobustCommand*{\mkbibrangetruncextra}[2]{%
  \iffieldundef{#2year}{%
    \iffieldundef{#2month}{}{%
      \printtext[#2date]{%
        \iffieldsequal{#2month}{#2endmonth}{%
