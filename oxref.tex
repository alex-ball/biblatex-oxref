...
%   Note that we clear fields rather than the bibmacros
%   as the `authoryear' style does.
% \end{itemize}
%
...
%
% \begin{itemize}
%   \item `compact' merges whole date with date label.
%   Note that we clear fields rather than the bibmacros
%   as the `authoryear' style does.
% \end{itemize}
%
...
%
% TODO: adjust mkbibrange macros from biblatex2.sty so they work in the
% absence of a year, so the clearfields above work as intended.
%
