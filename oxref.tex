...
\newoutputstream{preamble}
\openoutputfile{oxref-preamble.tex}{preamble}
\begin{writeverbatim}{preamble}
...
\fi
\fi
%\setmonofont[Scale=MatchLowercase]{LettrGoth12 BT}
...
\frenchspacing
\end{writeverbatim}
\closeoutputstream{preamble}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% OXNOTES BBX
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newoutputstream{notesbbx}
\openoutputfile{oxnotes.bbx}{notesbbx}
\begin{writeverbatim}{notesbbx}
...
\endinput
\end{writeverbatim}
\closeoutputstream{notesbbx}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% OXYEAR BBX
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newoutputstream{yearbbx}
\openoutputfile{oxyear.bbx}{yearbbx}
\begin{writeverbatim}{yearbbx}
...
\newoutputstream{lbx}
\openoutputfile{british-oxref.lbx}{lbx}
\begin{writeverbatim}{lbx}
...
\newoutputstream{bib}
\openoutputfile{oxref.bib}{bib}
\begin{writeverbatim}{bib}
% p.506
