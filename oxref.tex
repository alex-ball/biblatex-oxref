...
% the `bib-family-given/cite-given-family' name format.
%
...
\DeclareBibliographyOption[boolean]{scnames}[true]{%
  \csuse{bbx@opt@scnames@#1}%
}
\def\bbx@opt@scnames@true{%
  \renewcommand*{\mkbibnamefamily}[1]{%
    \ifbibliography{\textsc{##1}}{##1}%
  }%
...
\DeclareNameAlias[book]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[booklet]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[collection]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[manual]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[misc]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[mvbook]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[mvcollection]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[mvproceedings]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[mvreference]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[online]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[proceedings]{editor}{bib-family-given/cite-given-family}
\DeclareNameAlias[reference]{editor}{bib-family-given/cite-given-family}
%
% == Source mappings ==
%
...
\def\bbx@opt@mergedate@basic{%
  \renewbibmacro*{date+extrayear}{%
    \iffieldundef{\thefield{labeldatesource}year}
      {}
      {\printtext[parens]{%
         \printfield{\thefield{labeldatesource}year}%
         \printfield{extrayear}}}}%
  \renewbibmacro*{date}{%
    \iffieldundef{month}
      {}
